...
import com.nivethithasenthilkumar.automation.projects.crm.pages.Projects.ProjectPageCRM;
import com.nivethithasenthilkumar.automation.projects.crm.pages.SignIn.SignInPageCRM;
import com.nivethithasenthilkumar.automation.utils.LocalStorageUtils;
import com.nivethithasenthilkumar.automation.utils.LogUtils;
import com.nivethithasenthilkumar.automation.utils.ObjectUtils;
...
public class TestHandle {
    ...
    public void handleHTML5ValidationMessage() {
        WebUI.openWebsite("https://the-internet.herokuapp.com/login");
        WebUI.waitForPageLoaded();
    ...
    public void handleScreenshotElement() {
        WebUI.openWebsite("https://the-internet.herokuapp.com");
        WebUI.waitForPageLoaded();
        WebUI.screenshotElement(By.xpath("//div[@id='content']"), "Website_Testing_Module");
    }
