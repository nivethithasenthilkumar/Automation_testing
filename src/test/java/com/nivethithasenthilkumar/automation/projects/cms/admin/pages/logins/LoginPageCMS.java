package com.nivethithasenthilkumar.automation.projects.cms.admin.pages.logins;
...
import com.nivethithasenthilkumar.automation.projects.cms.users.pages.dashboard.DashboardPage;
...
import static com.nivethithasenthilkumar.automation.keywords.WebUI.clickElement;
...
public class LoginPageCMS extends CommonPageCMS {
    ...
    private By titleAdminPage = By.xpath("//img[@alt='Active eCommerce CMS']");
    ...
    public CommonPageCMS loginSuccessAdminPage(String email, String password) {
        ...
        setText(inputPassword, password);
        clickElement(buttonSubmitLogin);
        verifyElementVisible(titleAdminPage, "Admin page is NOT displayed.");
